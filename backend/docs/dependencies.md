...
| `@nestjs/platform-fastify` | ^11.1.27 | Fastify HTTP adapter (PRD 14.1) | Active | HTTP layer | N/A | Moderate |
...
| `@types/express` | Not needed because Fastify types are used |
| `cloudinary` | Media is now stored as externally hosted HTTPS links |
